...
def random_forest_train_test(x_train, x_test, y_train, y_test):
    ...
    return accuracy_score(rf_cls.predict(x_test), y_test) * 100, precision_score(rf_cls.predict(x_test), y_test) * 100, recall_score(rf_cls.predict(x_test), y_test) * 100
...
def svm_train_test(x_train, x_test, y_train, y_test):
    ...
    return accuracy_score(y_test, svm_pipe.predict(x_test)) * 100, precision_score(y_test, svm_pipe.predict(x_test)) * 100, recall_score(y_test, svm_pipe.predict(x_test)) * 100
